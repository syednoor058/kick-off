  ...
  return (
    <div className="py-10 md:py-20">
      <div className="ps-5 sm:ps-10 md:ps-16 lg:ps-20 text-primaryColor bg-accentColor flex flex-row justify-between">
        <div className="w-[60%] py-10 md:py-20 flex flex-col gap-3">
          ...
          <div className="flex flex-row gap-3">
            <input
              className="w-[800px] text-xs sm:text-sm md:text-base border-none outline-none bg-gray-100 rounded px-2 py-2 md:px-5 md:py-5"
              placeholder="Your Email Address"
            />
            <div className="w-full h-full text-xs sm:text-sm md:text-base bg-secondaryColor rounded uppercase flex justify-center items-center px-2 py-2 md:px-5 md:py-5">
              Subscribe
            </div>
          </div>
        </div>
